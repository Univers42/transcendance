...
- [Docker-Sponsored Open Source](https://hub.docker.com/search?badges=open_source)
  ...
  through an [open source program](/docker-hub/image-library/trusted-content/#docker-sponsored-open-source-software-images).

When you pick your base image, look out for the badges indicating that the
image is part of these programs.

![Docker Hub Official and Verified Publisher images](/build/images/hub-official-images.webp)
...
policy](/scout/policy/#up-to-date-base-images) checks whether the
...
[GitHub Actions](/build/ci/github-actions/) or another CI/CD pipeline to
